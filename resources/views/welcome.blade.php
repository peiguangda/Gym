  ...
  <!-- 
    ...
    <body>
            ...
            <header id="fh5co-header-section">
                <div class="container">
                    <div class="nav-header">
                        ...
                        <h1 id="fh5co-logo"><a href="http://localhost:8000/">Fit<span>ness</span></a></h1>
                        <!-- START #fh5co-menu-wrap -->
                        <nav id="fh5co-menu-wrap" role="navigation">
                            <ul  id="fh5co-primary-menu">
                                <a href="http://localhost:8000/login" class="btn btn-default">Login</a>
                                <a href="http://localhost:8000/register" class="btn btn-default">Regester</a>
                            </ul>
                        </nav>
                    </div>
                </div>
        ...
        <div class="fh5co-hero">
            ...
            <div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(https://media.sandiegoreader.com/img/places/banner05.jpg);">
                <div class="desc animate-box">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-7">
                                <h2>FitLife &amp; Health </h2>
                                <span><a class="btn btn-primary" href="http://localhost:8000/login">Join now</a></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row text-center">
                    <div class="col-md-4 col-sm-6">
                        <div class="program animate-box">
                            ...
                            <span><a href="href="http://localhost:8000/login" class="btn btn-default">Join Now</a></span>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="program animate-box">
